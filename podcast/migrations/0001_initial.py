# Generated by Django 2.2.23 on 2021-05-19 20:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('audio_file', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.File')),
                ('categories', models.ManyToManyField(blank=True, null=True, to='base.Category')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='podcast.Track')),
            ],
            options={
                'ordering': ('order',),
            },
        ...
        migrations.AddField(
            model_name='podcast',
            name='images',
            field=models.ManyToManyField(through='podcast.PodcastImage', to='base.Image'),
        ),
        migrations.AddField(
            model_name='podcast',
            name='product',
        ...
        migrations.AddField(
            model_name='podcast',
            name='tracks',
            field=models.ManyToManyField(through='podcast.PodcastTrack', to='podcast.Track'),
        ),
    ]
